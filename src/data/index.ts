...
export const personalInfo = {
  ...
  phone: "03253595050",
  whatsapp: "03253595050",
  location: "Dera Ghazi Khan, Punjab, Pakistan",
  linkedin: "https://www.linkedin.com/in/muhammadsohail-brohi",
};
...
export const projects = [
  {
    ...
    description:
      "A comprehensive sustainability tracking dashboard for large-scale enterprises.",
  ...
  },
  {
    ...
    description:
      "Cross-platform fintech application with real-time transaction monitoring.",
    image: "/projects/p2.jpg",
    tags: ["React Native", "Firebase", "Animatable"],
    github: "https://github.com",
    live: "https://example.com",
    category: "Mobile App",
  },
  {
    ...
    description:
      "Award-winning portfolio with advanced scroll animations and 3D scenes.",
